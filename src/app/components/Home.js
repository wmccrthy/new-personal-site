...
export default function Intro() {
    return (
        <div className="w-full flex flex-col items-center">
            ...
            <TypewriterText text="Amherst College 2025E', Software Engineer @ Roblox, NCAA DIII Men's Soccer Champion" typingSpeed={50} isHeader={false} keepBlinking={true} delay={2000}></TypewriterText>
        </div>
    );
}
