...
export default function About() {
    return (
        <motion.div
            ...
            className="flex flex-col md:flex-row gap-12 mx-auto w-11/12 max-w-5xl border border-gray-800 bg-black hover:border-sky-500 shadow-lg rounded-xl p-8 transition-all hover:scale-105 duration-300"
        >
            {/* Left Content */}
