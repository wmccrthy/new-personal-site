    ...
    <div className="flex flex-col justify-center align-middle content-center items-center overflow-y-scroll">
      ...
      <div className="flex justify-between content-between align-middle w-11/12 h-fit m-4 p-4 font-extralight">
        ...
        <div className="flex gap-8 align-middle justify-center text-lg content-between w-1/5">
          {/* pages */}
          <a className="w-1/3 cursor-pointer text-center items-center align-middle justify-center content-center hover:font-semibold transition-transform" onClick={() => handleInput(<Intro></Intro>)}>
            Home
          </a>
          <a className="w-1/3 cursor-pointer text-center items-center align-middle justify-center content-center hover:font-semibold transition-transform" onClick={() => handleInput(<About></About>)}>
            About
          </a>
          <a className="w-1/3 cursor-pointer text-center items-center align-middle justify-center content-center hover:font-semibold transition-transform" onClick={() => handleInput(<ProjectDeck projects={projects}></ProjectDeck>)}>
            Projects
          </a>
        </div>
      </div>

      <div className="flex flex-col w-2/3 items-center content-center justify-center align-middle h-[80vh]">
        {activePage}
